...
{
    public partial class RaporlarCariFaturalar : Form
    {
        public RaporlarCariFaturalar()
        {
            InitializeComponent();
        }
        ...
        public void IlkTariheGoreKasa()
        {
            ...
            OleDbDataAdapter dap = new OleDbDataAdapter("SELECT tedarikciler.unvan, CariEkstre.Tarih, CariEkstre.Aciklama, CariEkstre.FaturaTutari, CariEkstre.OdemeTutari, CariEkstre.Islem FROM tedarikciler INNER JOIN CariEkstre ON tedarikciler.TedarikciID = CariEkstre.TedarikciID WHERE (((CariEkstre.TedarikciID)=" + Cari + ") AND ((CariEkstre.Tarih) Between [@IlkD] And [@IkinciD])) GROUP BY tedarikciler.unvan, CariEkstre.Tarih, CariEkstre.Aciklama, CariEkstre.FaturaTutari, CariEkstre.OdemeTutari, CariEkstre.Islem", con);
        ...
        private void RaporlarKasaNakit_Load(object sender, EventArgs e)
        {
            ...
            Cari = CariFaturaRaporlari.SeciliCari;
            IlkTarih = CariFaturaRaporlari.IlkTarih;
            IkinciTarih = CariFaturaRaporlari.IkinciTarih;
